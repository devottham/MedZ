    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                <td width="30%" style="padding-left:20px" >
                                    <img src="../img/pat.png" alt="" width="100%" style="border-radius:50%">
                                </td>
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-sess">
                        <a href="medication.php" class="non-style-link-menu"><div><p class="menu-text">Patient Record</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-AI menu-active menu-icon-AI-active">
                        <a href="ai.php" class="non-style-link-menu   non-style-link-menu-active"><div><p class="menu-text">Chat Bot</p></a></div>
                    </td>
                </tr>
        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <td width="13%" >
                    <a href="ai.php" ><button  class="login-btn btn-primary-soft btn btn-icon-back"  style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:125px"><font class="tn-in-text">Back</font></button></a>
                    </td>
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Chat Bot</p>
                                ...
                                <td style="width: 25%;">
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex">
                                        ...
                                        <div>
                                                ...
                                                <h2 style="margin-top: 8px">Hospital Chatbot</h2><br>
                                                </div></div></div><br><br>
                                                <div class="chat-box" id="chatBox">
                                                <h2>Tell your Problem & get the remedies:</h2>
                                                <input type="text" id="userInput" placeholder="Type your message here...">
                                                <input type="submit" value="Send" id="send" onclick="sendMessage()">
                                                <div id="chatContent"></div> <!-- Chat messages will be appended here -->
                                                </div>
                                                </div><br>
                                                </td>
                                                </tr>         
