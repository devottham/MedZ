...
<form id="smsForm">
    ...
    <input type="text" id="to" name="to" placeholder="Enter phone number (e.g., +918072379779)" required>
    <br><br>
...
<input type="datetime-local" id="scheduledTime" name="scheduledTime" step="1" required>

    <br><br>
    
    <input type="submit" value="Send SMS" id="sendsms">
</form>
...
document.getElementById('smsForm').addEventListener('submit', function (event) {
    ...
    data.append('scheduledTime', scheduledTime); // Send the scheduled time
    ...
    .then(responseText => {
        document.getElementById('responseMessage').innerHTML = `<div style="color: green;">${responseText}</div>`;
    })
    .catch(error => {
        document.getElementById('responseMessage').innerHTML = `<div style="color: green;">SMS is sent.....</div>`;
    });
});
